...
def draw_graph(G, colors, pos, save_name = 'qaoa_large_weighted_test_vqc.png'):
...
with open('qaoa_weighted_vqc_test_res.json', 'w') as f:
...
plt.tight_layout()
plt.savefig('qaoa_weighted_vqc_test.png')