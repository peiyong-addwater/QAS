...
if __name__ == "__main__":
    ...
    final_prob_param, final_circ_param, final_prob_model, final_circ, final_k, final_op_list, final_loss, loss_list_qas, entropy_list_qas=\
    ...
    res_dict["prob_model_entropy_list"] = entropy_list_qas
